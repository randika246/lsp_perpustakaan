			...
			<table class="table" border="1">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<!-- tombol confirm, update dan delete-->
							<a href="confirm.php?id=<?php echo $row['id_pinjam'] ?>" onclick="return confirm('Yakin ?')">Confirm</a> ||
							<a href="detail.php?id=<?php echo $row['id_pinjam'] ?>">Detail</a> ||
							<a href="update.php?id=<?php echo $row['id_pinjam'] ?>">Update</a> ||
							<a href="delete.php?id=<?php echo $row['id_pinjam'] ?>" onclick="return confirm('Yakin ?')">Hapus</a>
						</td>
					</tr>
					<?php } ?>
